...
export const LizardHeader: FC<{ layoutTime: number; fps: number }> = ({
  layoutTime,
  fps,
}) => (
  <div
  ...
  >
    <div className="pretext-title">
      ...
      <p style={{ color: "var(--text-subtle)", margin: 0, fontSize: "11px" }}>
        WebGL 实时抠像 + WebWorker 异步分析 + Pretext 排版引擎
      </p>
    </div>
